...
{
    [NodeCustomEditor(typeof(WhileNode))]
    public class WhileNodeView : BaseNodeView, IFlowSubGraphNodeMinBounds
    {
        ...
        public override void Enable()
        {
            ...
            _subspaceLinksRow = SubspaceHeaderLinkRow.Create(
                titleContainer,
                _node.NodeId,
                ("\u0423\u0441\u043B\u043E\u0432\u0438\u0435", SubspaceKind.Condition),
